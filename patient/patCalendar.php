    ...
    <div class="main-wrapper">
        ...
        <div class="w-100">
            <form id="appointmentForm" enctype="multipart/form-data" method="POST">
                <div class="main-content" id="stepone">
                    <div>
                ...
                <div class="main-content" id="steptwo" style="display:none">
                    <h2>Select Date</h2>
                ...
                <div class="main-content" id="stepthree" style="display:none">
                    <?php
                    $userid = $_SESSION['id'];
                ...
                <div class="main-content" id="stepfour" style="display:none">
                ...
                <div class="main-content" id="stepfive" style="display:none">
                ...
                <div class="main-content" id="stepsix" style="display:none">
                    <div id="summary">
